...
struct URLStringTypeWithFakeURL: SessionType {
...
struct URLStringTypeWith500StatusCode: SessionType {
    var urlString: String {
...
struct URLStringTypeWithFakeJSONResponse: SessionType {
    var urlString: String {
...
struct URLStringTypeWithEmptyMatchesArray: SessionType {
    var urlString: String {
